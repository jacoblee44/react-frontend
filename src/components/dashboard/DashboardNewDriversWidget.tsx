...
const DashboardNewDriversWidget = () => {
    ...
    return (
        ...
        >
            ...
            {
                drivers.data?.map((driver: {id: string, user: { name: string, id: string }}) => <li key={driver.id}
                    ...
                    <div className="flex items-center gap-x-4">
                        <div className="hidden sm:flex sm:flex-col sm:items-end">
                            <p className="text-sm leading-6 text-gray-900">keine Zuordnung</p>
                        </div>
...
export default DashboardNewDriversWidget;